...
//TODO public static String notify_url = "http://beauty9.xicp.net/notify_url.jsp";
    public static String notify_url = "https://root.utools.club/payCheck";

    // 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
//TODO public static String return_url = "http://beauty9.xicp.net/consumer_center.html";
    public static String return_url = "https://root.utools.club/consumer_center.html";
